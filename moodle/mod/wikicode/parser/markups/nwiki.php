...
class nwikicode_parser extends wikicode_markup_parser {
    ...
    protected function tab_paragraph_block_rule($match) {
        ...
        $html = "";
        for($i = 0; $i < $num - 1; $i++) {
            $html = parser_utils::h('p', $html, array('class' =>'wikicode_tab_paragraph'));
        }
        
        return parser_utils::h('p', $text, array('class' =>'wikicode_tab_paragraph'));
    }
