...
class parser_utils {
    ...
    public static function wikicode_parser_link_callback($link, $options) {
        $l = urlencode($link);
    ...
    public static function wikicode_parser_table_callback($table) {
        $html = "";
        $headers = $table[0];
    ...
    public static function wikicode_parser_real_path($url) {
        return $url;
    }
}
