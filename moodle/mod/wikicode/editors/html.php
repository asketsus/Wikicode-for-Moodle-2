...
function wiki_print_editor_html($pageid, $content, $version = -1, $section = null, $upload = false, $deleteuploads = array()) {
    ...
    $OUTPUT->heading(strtoupper(get_string('formathtml', 'wikicode')));
    ...
    echo $OUTPUT->container(print_textarea(true, 20, 100, 0, 0, "newcontent", $content, 0, true, '', 'form-textarea-advanced'), 'wikicode_editor');
