...
var CodeMirror = (function(){
  ...
  function CodeMirror(place, options) {
    ...
    var tlHack = this.textareaTimelast = document.createElement("TEXTAREA");
    div.appendChild(tlHack);
    tlHack.style.position = "absolute";
    tlHack.style.left = "-10000px";
    tlHack.style.width = "10px";
    tlHack.value = time();
