...
class moodle1_mod_wiki_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'wiki', '/MOODLE_BACKUP/COURSE/MODULES/MOD/WIKICODE',
                array(
                    'newfields' => array(
                        'introformat' => '0',
            ...
            new convert_path(
                'wiki_entries', '/MOODLE_BACKUP/COURSE/MODULES/MOD/WIKICODE/ENTRIES',
                array(
                    'newfields' => array(
                        'synonyms' => '0',
                        'links' => 'collaborative',
            ...
            new convert_path(
                'wiki_entry', '/MOODLE_BACKUP/COURSE/MODULES/MOD/WIKICODE/ENTRIES/ENTRY'
            ),
            new convert_path(
                'wiki_pages', '/MOODLE_BACKUP/COURSE/MODULES/MOD/WIKICODE/ENTRIES/ENTRY/PAGES'
            ),
            new convert_path(
                'wiki_entry_page', '/MOODLE_BACKUP/COURSE/MODULES/MOD/WIKICODE/ENTRIES/ENTRY/PAGES/PAGE',
                array(
                    'newfields' => array(
    ...
    public function process_wiki($data) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_wikicode');
        ...
        $this->open_xml_writer("activities/wiki_{$this->moduleid}/wikicode.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $this->moduleid,
            'modulename' => 'wikicode', 'contextid' => $contextid));
