...
$string['editoption'] = 'Editor options';
$string['editoption_help'] = 'Is not necessary any lock button, when you edit a function this is automatic locked by your user.

* Unlock - Open a popup with info about our locked functions. You can unlock your functions here.
* Refresh - Load code editor with the last info. This operation is automatic while code is being edited.
* Save - Save code to the historical. Code version is automatic-saved when you push enter, semicolon or backspace. You can save your version in this option.';
...
$string['timeedit_help'] = 'Time from start of the code editing until completion while code is being edited';
$string['timetotal'] = 'Total Time';
$string['timetotal_help'] = 'Time from start of the code editing until completion';
