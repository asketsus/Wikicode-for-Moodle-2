...
M.mod_wikicode.renew_lock = function(Y, args) {
    function renewLock() {
        var args = {};
...
M.mod_wikicode.history = function(Y, args) {
    var compare = false;
...
M.mod_wikicode.deleteversion = function(Y, args) {
...
M.mod_wikicode.init_tree = function(Y, expand_all, htmlid) {
